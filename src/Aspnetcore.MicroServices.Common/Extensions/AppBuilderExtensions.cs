...
using Aspnetcore.MicroServices.Common.Constants;
...
namespace Aspnetcore.MicroServices.Common.Extensions
{
    public static class AppBuilderExtensions
    {
        ...
        {
            var openApiSection = configuration.GetSection(AppSettingsSection.OpenApi);
